...
# Configuración de la página (sin mensajes automáticos)
st.set_page_config(
...
if uploaded_file is not None:  # Cambio clave: solo entra si hay archivo
    try:
